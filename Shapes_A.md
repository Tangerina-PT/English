...
***Vocabulário base:*** **star (estrela), circle (círculo), heart (coração), line (linha);** ***Extensão:*** **square (quadrado), triangle (triângulo), rectangle (rectângulo), diamond (diamante), oval (ovale)**
