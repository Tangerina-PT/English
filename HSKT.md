...
(5). The real challenge: can you sing the song and point to the correct pictures when the pictures are not in order? / O verdadeiro desafio: consegues cantar ao apontar para as imagens quando estão fora de ordem.  
