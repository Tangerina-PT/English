...
Instrucções para Wordwall: Seleciona um jogo do painel branco a direita e clica no 'START'. Escolha o nível a que queres trabalhar: Nível 1 (jogar com 6 expressões); Nível 2 (jogar com 9 expressões); Nível 3 (jogar com 12 expressões):  
