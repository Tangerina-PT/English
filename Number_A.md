...
* Some resources seem only to work with Internet Explorer/Edge so if an activity doesn't load in your habitual browser try Internet Explorer/Edge. / Alguns recursos parecem só funcionar com Internet Explorer/Edge, por isso, se uma actividade não carregar no browser habitual, tente no Internet Explorer/Edge.
